//// This file comprises the input JSON values for the unit tests
//// for outbound.js functionality. There is no functional code
//// in this file, just JSON. 

// Note: Responses include copyright info which changes annually, so it's
// omitted from these object samples to maintain usability over time.

var OutboundTestPrimitives = {
    TestInputTeams_NoModifiers : {
    ...
    TestInputTeamsWithID_NoModifiers : {
        "copyright": "NHL and the NHL Shield are registered trademarks of the National Hockey League. NHL and NHL team marks are the property of the NHL and its teams. © NHL 2021. All Rights Reserved",
        "teams" : [ {
          "id" : 10,
          "name" : "Toronto Maple Leafs",
...
module.exports = {
    OutboundTestPrimitives : OutboundTestPrimitives
};