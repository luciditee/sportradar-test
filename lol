...
generating endpoint from primitive [object Object]
generating endpoint modifier [object Object]
generating endpoint modifier [object Object]
generating endpoint modifier [object Object]
generating endpoint from primitive [object Object]
generating endpoint modifier [object Object]
...
OutboundHandler {
  ...
  connectionOptions: 
   { hostname: 'statsapi.web.nhl.com',
     ...
     path: '/api',
     method: 'GET' } }
observed string request for endpoint slug: Teams
found endpoint
Requesting the following: `https://statsapi.web.nhl.com/api/v1/teams'
Success! Response printing for request URI 200
{
